...
def prepare_run_command_tool(agent_manager: AgentContext):
    @trace(agent_manager)
    def run_command(command: str) -> tuple[int, str]:
        ...
        container = get_container(agent_manager.get_chat_id())
...
def prepare_create_file_tool(agent_manager: AgentContext):
    @trace(agent_manager)
