        ...
        try:
            ...
            for image_link, caption in _extract_image_links_from_api_response(output):
                ...
                if image_base64 is not None:
                    _add_image_to_trace_history(agent_manager, image_base64)
